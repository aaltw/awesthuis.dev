...
@Component({
  selector: 'blog-home',
  template: `
    <div class="min-h-screen bg-gradient-to-r from-slate-900 to-slate-700 transition-colors duration-300">
      <!-- Theme Toggle -->
      <button 
        (click)="toggleTheme()"
      ...
      <div class="flex items-center justify-center min-h-screen px-6">
        <div class="text-center">
          <h1 class="text-6xl md:text-8xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent mb-6">
            awesthuis.dev
          </h1>
